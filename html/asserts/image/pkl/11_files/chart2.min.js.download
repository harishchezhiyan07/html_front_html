...
!(function(t, e) {
  ...
  var U,
    ...
    K = {
      ...
      inherits: function(t) {
        ...
        return (
          (n.prototype = e.prototype), (i.prototype = new n()), (i.extend = K.inherits), t && K.extend(i.prototype, t), (i.__super__ = e.prototype), i
        );
      }
    },
    G = K;
  ...
  var dt = {
      ...
      resolve: function(t, e, i) {
        ...
        for (n = 0, a = t.length; n < a; ++n)
          if (
            void 0 !== (o = t[n]) &&
            (void 0 !== e && "function" == typeof o && (o = o(e)), void 0 !== i && G.isArray(o) && (o = o[i]), void 0 !== o)
          )
            return o;
      }
    },
        ...
        for (
          ...
          (e = s[t]),
            ...
            0 === t
              ...
              : ((i = -1 === u ? i : s[u]),
                n.skip || ((u !== t - 1 && !r) || -1 === u ? o.moveTo(n.x, n.y) : ut.canvas.lineTo(o, i._view, e._view), (u = t)));
        o.stroke(), o.restore();
      }
    }),
  ...
  var Ze = pt.extend({
          ...
          c.filter &&
            ...
            (b = (function(t, e, i, n) {
              ...
              return (
                "right" === d
                  ? (a -= e.width)
                  : "center" === d && ((a -= e.width / 2) + e.width > n.width && (a = n.width - e.width), a < 0 && (a = 0)),
      ...
      getCaretPosition: function(t, e, i) {
        ...
        if ("center" === c)
          (s = g + m / 2),
            "left" === h ? ((a = (n = f) - d), (o = n), (r = s + d), (l = s - d)) : ((a = (n = f + p) + d), (o = n), (r = s - d), (l = s + d));
        else if (
          ("left" === h
            ? ((n = (a = f + u + d) - d), (o = a + d))
            : "right" === h
  ...
  ut.extend(ni.prototype, {
    ...
    updateLayout: function() {
      !1 !== Ee.notify(this, "beforeLayout") &&
        (ke.update(this, this.width, this.height), Ee.notify(this, "afterScaleUpdate"), Ee.notify(this, "afterLayout"));
    },
  ...
  var bi = fi.extend({
      ...
      getTickLimit: function() {
        var t,
          ...
          n = e.maxTicksLimit;
        return (
          i ? (t = Math.ceil(this.max / i) - Math.floor(this.min / i) + 1) : ((t = this._computeTickLimit()), (n = n || 11)),
          n && (t = Math.min(n, t)),
          t
        );
      },
          ...
          ut.each(n, function(n, a) {
            ...
            i.isDatasetVisible(a) &&
              ...
              ut.each(n.data, function(i, n) {
                ...
                isNaN(a) ||
                  r.data[n].hidden ||
                  ((d[n] = d[n] || 0), (u[n] = u[n] || 0), e.relativePoints ? (d[n] = 100) : a < 0 ? (u[n] += a) : (d[n] += a));
              });
          }),
          ...
          (e.angleLines.display || e.pointLabels.display) &&
            (function(t) {
              ...
              e.save(),
                ...
                (e.strokeStyle = s),
                e.setLineDash &&
                  (e.setLineDash(Ai([n.borderDash, a.borderDash, []])), (e.lineDashOffset = Ai([n.borderDashOffset, a.borderDashOffset, 0])));
          ...
          (n._offsets = (function(t, e, i, n, a) {
            ...
            return (
              a.offset &&
                ...
                a.time.max ||
                  ((r = Xi(t, "time", e[e.length - 1], "pos")), (l = 1 === e.length ? r : (r - Xi(t, "time", e[e.length - 2], "pos")) / 2))),
              { start: s, end: l }
            );
          })(n._table, d, 0, 0, r)),
